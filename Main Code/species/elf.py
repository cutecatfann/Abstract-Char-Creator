...
class Elf(SpeciesInt):
    """
    Creates the specific base Elf species. It inherents from the abstract SpeciesInterface,
    and includes the data needed for the basic Elf species.
    """
